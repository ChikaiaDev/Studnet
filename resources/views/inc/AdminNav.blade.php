<nav class="navbar navbar-default navbar-static-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Discussions
                ...
                <li class="dropdown">
                    <a href="/news" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">News Feed
                        <span class="caret"></span>
                    </a>

                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/news/create">Create New NewsFeed</a></li>
